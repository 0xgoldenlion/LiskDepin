...
def main():
    ...
    rpc_url = os.getenv("RPC_URL", "https://rpc.sepolia-api.lisk.com")
    contract_address = Web3.to_checksum_address(os.getenv("CONTRACT_ADDRESS", "0xC7d966Cc0E5Ec53940D31cf64426b3198678c181"))
